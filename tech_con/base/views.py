...
from .models import Logo, Header, Header2, MainAdversiment, Blog, AllSingleAdversiment, Suggestion, Footer
...
def home(request):
    ...
    context = {'logos':logos, 'headers':headers, 'header2s':header2s, 'adses':adses, 'blogs':blogs, 'page_obj':page_obj, 'suggests':suggests, 'footers': footers}
...
def header_detail(request, header_name):
    ...
    context = {'header_d':header_d, 'logos':logos, 'allsingles':allsingles, 'suggests':suggests, 'alsolikes':alsolikes, 'footers':footers}
...
def header_detail2(request, pk):
    ...
    context = {'header_d2':header_d2, 'logos':logos, 'allsingles':allsingles, 'suggests':suggests, 'alsolikes':alsolikes, 'footers':footers}
...
def blog_detail(request, blog_name):
    ...
    context = {'blog_d':blog_d, 'logos':logos, 'allsingles': allsingles, 'suggests':suggests, 'alsolikes':alsolikes, 'footers':footers}
